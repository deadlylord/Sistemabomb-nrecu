                ...
                {isUserDropdownOpen && (
                  <div className="absolute top-14 right-0 mt-2 w-64 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-2xl shadow-2xl overflow-hidden animate-fade-in z-[200]">
                    ...
                    <div className="p-2 space-y-1">
                      ...
                      <button onClick={() => { onOpenInstallGuide(); setIsUserDropdownOpen(false); }} className="flex items-center gap-3 w-full px-3 py-2 rounded-xl text-sm font-bold text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition-all">
      ...
      <aside className="hidden lg:flex flex-col lg:w-64 fixed left-0 top-16 bottom-0 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 z-30 overflow-y-auto transition-all duration-300 py-4 px-3 space-y-5 scrollbar-thin">
        ...
        <div className="pt-4 border-t border-slate-100 dark:border-slate-800">
          <button 
            ...
            className="flex items-center gap-3 w-full px-3 py-2.5 rounded-xl text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white transition-all text-left group"
          >
            <div className="p-1.5 rounded-lg bg-accent/10 text-accent group-hover:bg-accent group-hover:text-white transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
              </svg>
            </div>
            <div className="flex-grow min-w-0">
              <p className="text-xs font-black leading-none">Instalar App Celular</p>
              <p className="text-[10px] text-slate-400 dark:text-slate-500 mt-1 truncate">Usar app nativa sin navegador</p>
            </div>
          </button>
        </div>
      </aside>
