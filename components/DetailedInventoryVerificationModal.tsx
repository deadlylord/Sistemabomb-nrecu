    ...
    try {
      ...
      if (isAdmin) {
          ...
          const historyData = historySnap.docs
            ...
            // FIX: Explicitly cast to string to ensure compatibility with new Date() constructor and avoid unknown type errors (fixes line 197 issue)
            ...
            <div className="bg-orange-600 text-white p-3 px-6 flex justify-between items-center shadow-lg z-20">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        {/* FIX: Explicitly cast updatedAt to string to resolve unknown type issues for Date constructor */}
                        <p className="text-[10px] font-bold opacity-80 mt-1">Estado guardado por {(auditModeEntry as any).lastUpdatedBy} el {new Date((auditModeEntry.updatedAt as string) || '').toLocaleString()}</p>
                    </div>
                </div>
